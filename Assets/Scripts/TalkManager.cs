...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        // K : key가 11000~이면 배드엔딩에 대한 text data
        ...
        talkData.Add(11004, new string[] { "너무 쓸쓸하다..", "마지막으로 대화를 한게 언제였지?" }); // 외로움
        talkData.Add(11005, new string[] { "바...바.아악..사..니이..님...!", "제..제에...가....왜...이..이이...러죠오...?", "삐-----익 포맷 되었습니다" }); // 에러
        talkData.Add(11006, new string[] { "으아아아아악!", "....." }); // 감전사
        talkData.Add(11007, new string[] { "오늘은 토끼 고기로 포식하겠어!", "멧돼지다!! 도망가자!!", "너무 멋있지 않아요?" }); // 멧돼지
