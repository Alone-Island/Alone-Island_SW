...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(11000, new string[] { "하...너무.. 배..고파...", "아무것도.. 못..하겠어..." });   //배고픔
        ...
        talkData.Add(11003, new string[] { "쿨럭...", "읔..피가..", "혹시.. 방금 먹은 열매에 독이..?" }); // 독열매
        talkData.Add(11004, new string[] { "바...바.아악..사..니이..님...!", "제..제에...가....왜...이..이이...러죠오...?", "삐-----------------", "포맷 되었습니다" }); // 에러
        talkData.Add(11005, new string[] { "으아아아아악!", "....." }); // 감전사
        talkData.Add(11006, new string[] { "오늘은 토끼 고기로 포식하겠어!", "멧돼지다!! 도망가자!!" }); // 멧돼지
